...
public class AlchemyCircleRender extends EntityImageRender {
    AlchemyCircleRender(){
        super();
        texturePath = "UI.upgrading.alchemyCircle.alchemyCircleAnim";
        Objects.requireNonNull(TextureLoader.getAnimationClass("UI.upgrading.alchemyCircle.alchemyCircleAnim")).setRunning(true);
        Objects.requireNonNull(TextureLoader.getAnimationClass("UI.upgrading.alchemyCircle.alchemyCircleAnim")).setFrame(0);

    }
    public void render(Entity e1){
        AlchemyCircle e = (AlchemyCircle) e1;
